...
instagramButtons.forEach((button) => {
  button.addEventListener("click", function () {
    window.location.href = "https://www.instagram.com/hello.sosh.world/";
  });
});

// Link Github repos to project cards
const aws_sent_analysis_news_repo =
  "https://github.com/SWEN-514-614-2231/term-project-team01";
const aws_sent_analysis_news_btn = document.querySelector(
  ".aws_sent_analysis_news"
);
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    emailjs.send("service_q76dg58", "contact_form", templateParams).then(
      function (response) {
